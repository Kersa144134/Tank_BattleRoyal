	...
	SubShader
	{
		...
		Pass
		{
				...
				, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				#else
				float staticSwitch162 = input.ase_texcoord7.xyz.y;
				#endif
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float staticSwitch162 = ( FinalWorldPosition135.y / ase_objectScale.y );
				#else
				float staticSwitch162 = input.ase_texcoord3.xyz.y;
				#endif
				float temp_output_146_0 = abs( ( (0.0 + (staticSwitch162 - 0.0) * (1.0 - 0.0) / (_MaskAppearLocalYRemap - 0.0)) + _MaskAppearLocalYAdd ) );
				#ifdef _MASKAPPEARINVERT_ON
				float staticSwitch153 = ( 1.0 - temp_output_146_0 );
...
Node;AmplifyShaderEditor.SamplerNode;157;3732.961,2241.487;Inherit;True;Property;_MaskAppearRamp;Mask Appear Ramp;28;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
ASEEND*/
//CHKSM=C764D1FEC68590E85A59F20C405D1DCFB0E47A48